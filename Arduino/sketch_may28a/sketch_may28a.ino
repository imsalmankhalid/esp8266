...
const char* ssid = "test"; // Enter the SSID of your WiFi Network.
...
byte sendEmail()
{
  ...
  */
  espClient.println("cGF0aWVudG1vbml0b3IxMjFAZ21haWwuY29t"); //base64, ASCII encoded Username
  if (!emailResp()) 
    return 0;
  //
  ...
  */
  espClient.println("cGVOWHhKUldLb1p0");//base64, ASCII encoded Password
  if (!emailResp()) 
    return 0;
  //
  Serial.println(F("Sending From"));
  // change to sender email address
  espClient.println(F("MAIL From: patientmonitor121@gmail.com"));
  if (!emailResp()) 
    return 0;
  // change to recipient address
  Serial.println(F("Sending To"));
  espClient.println(F("RCPT To: patientmonitor121@gmail.com"));
  if (!emailResp()) 
    return 0;
  //
  ...
  // change to recipient address
  espClient.println(F("To:  patientmonitor121@gmail.com"));
  // change to your address
  espClient.println(F("From: patientmonitor121@gmail.com"));
