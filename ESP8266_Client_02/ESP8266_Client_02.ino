...
//      Serial.println(line);                                           // exit
       ...
       if(Serial.available()>0)
      {
          ...
          Serial.print("sent to the server: " + str);
      ...
      TCP_Client.println(str);                             // important to use println instead of print, as we are looking for a '\r' at the client
      TCP_Client.flush();
